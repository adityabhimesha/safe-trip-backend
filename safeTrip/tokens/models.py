...
class Tokens(models.Model):
    ...
    pair_base_address = models.CharField(
        max_length=255, null=False, default="")
    pair_quote_address = models.CharField(
        max_length=255, null=False, default="")
    ...
    sponsored_details = models.CharField(
...
class PancakeTokens(models.Model):
    pair_address = models.CharField(
        max_length=255, null=False, primary_key=True)
    pair_base_name = models.CharField(max_length=255, null=False,)
    pair_quote_name = models.CharField(max_length=255, null=False, default="")
...
class UniswapTokens(models.Model):
    pair_address = models.CharField(
        max_length=255, null=False, primary_key=True)
    pair_base_name = models.CharField(max_length=255, null=False,)
    pair_quote_name = models.CharField(max_length=255, null=False, default="")
...
class MaticTokens(models.Model):
    pair_address = models.CharField(
        max_length=255, null=False, primary_key=True)
    pair_base_name = models.CharField(max_length=255, null=False,)
    pair_quote_name = models.CharField(max_length=255, null=False, default="")
